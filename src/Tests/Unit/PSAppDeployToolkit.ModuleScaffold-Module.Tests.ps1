BeforeAll {
    ...
    #-------------------------------------------------------------------------
    $ModuleName = 'PSAppDeployToolkit.Tools'
...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module PSAppDeployToolkit.Tools.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain PSAppDeployToolkit.Tools.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "PSAppDeployToolkit.Tools.psm1"
        } #validPSM1
